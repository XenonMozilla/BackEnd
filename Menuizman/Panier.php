<?php
require "webelement/include/ProduitModel.php";
require "webelement/include/fonction.php";
$Total = 0;
$Quantite = 0;
...
require 'webelement/include/header.php';
/*
...
?>
<?php
require 'webelement/include/footer.php';
?>