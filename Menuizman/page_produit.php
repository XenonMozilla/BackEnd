...
include "webelement/include/functions.php";
...
$produit = $produitStatement->fetchAll();
    ...
    echo '<img src="data:image/jpeg;base64,'.base64_encode($produit[0]['PRD_PICTURE']).'" alt="Produit : ID = '.$produit[0]['PRD_ID'].'"/>';
    echo '</div> ';
    ...
    echo '<a href="panier.php?action=ajout&amp;l='.$produit[0]['PRD_DESCRIPTION'].'&amp;q=1&amp;p='.$produit[0]['PRD_PRICE'].'" return false;"  class="add-to-cart btn btn-primary">Ajouter au panier</a>';
    echo '</div>';
